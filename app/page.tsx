...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ position: 'relative' }}>
      ...
      {/* Services Section - Desktop Bold */}
      <section id="services" className="py-16 sm:py-24 lg:py-40 xl:py-48 relative bg-gray-50">
        <div className="section-divider" />
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 pt-16 sm:pt-24 lg:pt-32">
          {/* Header */}
          <div className="text-center mb-12 sm:mb-16 lg:mb-24">
            <ScrollReveal>
              <h2 className="font-heading text-mobile-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tighter mb-6 sm:mb-8 lg:mb-10 px-4 sm:px-0">
                Transform Your Business{" "}
                <span style={{ color: '#1ebda5' }}>with AI</span>
              </h2>
            </ScrollReveal>
            <ScrollReveal delay={100}>
              <p className="text-mobile-lg sm:text-xl lg:text-2xl text-gray-700 max-w-3xl mx-auto mb-10 sm:mb-12 lg:mb-16 px-4 sm:px-0 font-medium leading-relaxed">
                We don't just talk AI. We build it. Real solutions. Real results.
              </p>
            </ScrollReveal>
            <ScrollReveal delay={200}>
              <p className="text-mobile-xs sm:text-sm lg:text-base font-mono tracking-[0.2em] lg:tracking-[0.3em] text-muted-foreground mb-4 sm:mb-6 font-medium">WHAT WE OFFER</p>
            </ScrollReveal>
            <ScrollReveal delay={300}>
              <h3 className="font-heading text-mobile-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-3 sm:mb-4 lg:mb-6 px-4 sm:px-0">Our Services</h3>
            </ScrollReveal>
            <ScrollReveal delay={400}>
              <p className="text-mobile-base sm:text-lg lg:text-xl text-muted-foreground px-4 sm:px-0 font-medium">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12 xl:gap-16">
            {/* AI Consulting - Desktop Enhanced */}
            <ScrollReveal delay={100}>
              <div className="card-entrance card-entrance-delay-1 group p-5 sm:p-6 lg:p-10 h-full flex flex-col transition-all duration-300 angled-border-subtle bg-white shadow-md hover:shadow-2xl hover:-translate-y-2" style={{ border: '2px solid #1ebda5' }}>
            ...
            {/* AI Agent Building */}
            <ScrollReveal delay={200}>
              <div className="card-entrance card-entrance-delay-2 group p-5 sm:p-6 lg:p-10 h-full flex flex-col transition-all duration-300 angled-border-subtle bg-white shadow-md hover:shadow-2xl hover:-translate-y-2" style={{ border: '2px solid #e26a00' }}>
            ...
            {/* Web App & Design */}
            <ScrollReveal delay={300}>
              <div className="card-entrance card-entrance-delay-3 group p-5 sm:p-6 lg:p-10 h-full flex flex-col transition-all duration-300 angled-border-subtle bg-white shadow-md hover:shadow-2xl hover:-translate-y-2" style={{ border: '2px solid #c49f00' }}>
      ...
      {/* Process Section - Desktop Bold */}
      <section id="process" className="py-16 sm:py-24 lg:py-40 xl:py-48 relative overflow-hidden">
        <div className="section-divider" />
        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 pt-16 sm:pt-24 lg:pt-32 relative" style={{ zIndex: 1 }}>
          {/* Header */}
          <div className="text-center mb-12 sm:mb-16 lg:mb-24">
            <ScrollReveal>
              <div className="inline-block px-4 sm:px-5 lg:px-6 py-2 rounded-full mb-5 sm:mb-6 lg:mb-8" style={{ background: 'rgba(255, 255, 255, 0.9)' }}>
                <p className="text-mobile-xs sm:text-sm lg:text-base font-medium tracking-wider text-gray-700">HOW WE WORK</p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={100}>
              <h2 className="font-heading text-mobile-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tighter mb-6 sm:mb-8 lg:mb-10 text-white drop-shadow-lg px-4 sm:px-0">
                Our Process
              </h2>
            </ScrollReveal>
            <ScrollReveal delay={200}>
              <p className="text-mobile-base sm:text-lg lg:text-xl xl:text-2xl text-white/90 max-w-3xl mx-auto drop-shadow px-4 sm:px-0 font-medium">
                From idea to implementation, we guide you every step of the way
              </p>
            </ScrollReveal>
          </div>

          {/* Process Cards - Desktop Enhanced */}
          <div className="grid md:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 xl:gap-12 relative">
            {/* Connecting Line */}
            ...
            {/* Card 1 - Discover */}
            <ScrollReveal delay={100}>
              <div className="relative bg-white rounded-2xl p-5 sm:p-6 lg:p-8 xl:p-10 text-center shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300" style={{ zIndex: 1 }}>
                <div className="w-12 sm:w-16 lg:w-20 h-12 sm:h-16 lg:h-20 mx-auto mb-4 sm:mb-5 lg:mb-6 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #f0f0f0 0%, #e0e0e0 100%)' }}>
                  <svg className="w-6 sm:w-8 lg:w-10 h-6 sm:h-8 lg:h-10 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                  </svg>
                </div>
                <p className="text-mobile-xs sm:text-sm font-medium text-gray-500 mb-2">01</p>
                <h3 className="font-heading text-mobile-lg sm:text-xl lg:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3 lg:mb-4">Discover</h3>
                <p className="text-mobile-sm sm:text-sm lg:text-base text-gray-600 leading-relaxed">
                  We learn your business, challenges, and goals
                </p>
                <div className="mt-4 sm:mt-5 lg:mt-6 h-1 bg-gray-200 rounded-full" />
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={200}>
              <div className="relative bg-white rounded-2xl p-5 sm:p-6 lg:p-8 xl:p-10 text-center shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300" style={{ zIndex: 1 }}>
                ...
                <p className="text-mobile-xs sm:text-sm font-medium text-gray-500 mb-2">02</p>
                <h3 className="font-heading text-mobile-lg sm:text-xl lg:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3 lg:mb-4">Design</h3>
                <p className="text-mobile-sm sm:text-sm lg:text-base text-gray-600 leading-relaxed">
            ...
            <ScrollReveal delay={300}>
              <div className="relative bg-white rounded-2xl p-5 sm:p-6 lg:p-8 xl:p-10 text-center shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300" style={{ zIndex: 1 }}>
                ...
                <p className="text-mobile-xs sm:text-sm font-medium text-gray-500 mb-2">03</p>
                <h3 className="font-heading text-mobile-lg sm:text-xl lg:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3 lg:mb-4">Develop</h3>
                <p className="text-mobile-sm sm:text-sm lg:text-base text-gray-600 leading-relaxed">
            ...
            <ScrollReveal delay={400}>
              <div className="relative bg-white rounded-2xl p-5 sm:p-6 lg:p-8 xl:p-10 text-center shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300" style={{ zIndex: 1 }}>
                ...
                <p className="text-mobile-xs sm:text-sm font-medium text-gray-500 mb-2">04</p>
                <h3 className="font-heading text-mobile-lg sm:text-xl lg:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3 lg:mb-4">Deploy</h3>
                <p className="text-mobile-sm sm:text-sm lg:text-base text-gray-600 leading-relaxed">
      ...
      {/* PayPro AI Section - Desktop Bold */}
      <section id="paypro" className="py-16 sm:py-24 lg:py-40 xl:py-48 relative bg-gray-50">
        <div className="section-divider" />
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 pt-16 sm:pt-24 lg:pt-32">
          {/* Header */}
          <div className="text-center mb-12 sm:mb-16 lg:mb-24">
            <ScrollReveal>
              <h2 className="font-heading text-mobile-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tighter mb-6 sm:mb-8 lg:mb-10 text-foreground px-4 sm:px-0">
                AI isn't coming,<br />it's here.
              </h2>
            </ScrollReveal>
            <ScrollReveal delay={100}>
              <p className="text-mobile-lg sm:text-xl lg:text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed px-4 sm:px-0 font-medium">
      ...
      <section id="portfolio" className="py-16 sm:py-24 lg:py-40 xl:py-48 relative">
        <div className="section-divider" />
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 pt-16 sm:pt-24 lg:pt-32">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12 sm:mb-16 lg:mb-20 gap-4 sm:gap-6">
            <div>
              <ScrollReveal>
                <p className="text-mobile-xs sm:text-sm lg:text-base font-mono tracking-[0.2em] lg:tracking-[0.3em] text-muted-foreground mb-4 sm:mb-6 font-medium">OUR WORK</p>
              </ScrollReveal>
              <ScrollReveal delay={100}>
                <h2 className="font-heading text-mobile-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight">Portfolio</h2>
              </ScrollReveal>
            </div>
            <ScrollReveal delay={200}>
              <p className="text-mobile-sm sm:text-base lg:text-lg text-gray-700 max-w-md font-medium">We don't do MVPs. We ship products that feel inevitable.</p>
            </ScrollReveal>
          </div>
      ...
      {/* Insights Section - Desktop Bold */}
      <section id="insights" className="py-16 sm:py-24 lg:py-40 xl:py-48 relative overflow-hidden">
        <div className="section-divider" />
        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 pt-16 sm:pt-24 lg:pt-32 relative" style={{ zIndex: 1 }}>
          <ScrollReveal>
            <p className="text-mobile-xs sm:text-sm lg:text-base font-mono tracking-[0.2em] lg:tracking-[0.3em] text-white mb-5 sm:mb-6 lg:mb-8 drop-shadow-lg font-medium">INSIGHTS</p>
          </ScrollReveal>
          <ScrollReveal delay={100}>
            <h2 className="font-heading text-mobile-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tighter mb-6 sm:mb-8 lg:mb-10 text-white drop-shadow-lg px-4 sm:px-0">Recent Thoughts</h2>
          </ScrollReveal>
          <ScrollReveal delay={200}>
            <p className="text-mobile-base sm:text-lg lg:text-xl xl:text-2xl text-white max-w-2xl mb-12 sm:mb-16 lg:mb-24 drop-shadow-lg px-4 sm:px-0 font-medium">
              Personal research on where AI is, where it's going, and what matters.
            </p>
          </ScrollReveal>

          <div className="grid md:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 xl:gap-12">
            {insights.map((post, index) => (
              <ScrollReveal key={post.title} delay={index * 100}>
                <div className="group p-6 sm:p-8 lg:p-10 border border-white/30 angled-border-subtle cursor-pointer h-full flex flex-col transition-all duration-300 hover:border-white/70 bg-white/10 backdrop-blur-md hover:bg-white/20 hover:-translate-y-2 hover:shadow-2xl">
                  <div className="flex items-center gap-2.5 sm:gap-3 text-mobile-xs sm:text-sm lg:text-base text-white/90 mb-4 sm:mb-5 lg:mb-6">
                    <span>{post.date}</span>
                    <span className="w-1 h-1 bg-white/90 rounded-full" />
                    <span>{post.readTime}</span>
                  </div>
                  <h3 className="font-heading text-mobile-lg sm:text-xl lg:text-2xl font-semibold text-white flex-grow">{post.title}</h3>
                  <div className="mt-6 sm:mt-8 flex items-center gap-2 text-mobile-xs sm:text-sm lg:text-base text-white/90 group-hover:text-white transition-colors duration-200">
                    Read more
      ...
      {/* Connect Section - Desktop Bold */}
      <section id="connect" className="py-16 sm:py-24 lg:py-40 xl:py-48 relative bg-gray-50">
        <div className="section-divider" />
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 pt-16 sm:pt-24 lg:pt-32">
          <div className="max-w-3xl mx-auto text-center relative">
            ...
            <div className="relative" style={{ zIndex: 0 }}>
              <ScrollReveal>
                <p className="text-mobile-xs sm:text-sm lg:text-base font-mono tracking-[0.2em] lg:tracking-[0.3em] text-muted-foreground mb-5 sm:mb-6 lg:mb-8 font-medium">GET IN TOUCH</p>
              </ScrollReveal>
              <ScrollReveal delay={100}>
                <h2 className="font-heading text-mobile-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tighter mb-6 sm:mb-8 lg:mb-10 px-4 sm:px-0">
              ...
              <ScrollReveal delay={200}>
                <p className="text-mobile-base sm:text-lg lg:text-xl xl:text-2xl text-gray-700 max-w-xl mx-auto mb-12 sm:mb-16 lg:mb-20 px-4 sm:px-0 font-medium">
              ...
              <ScrollReveal delay={300}>
                <div className="p-8 sm:p-10 lg:p-14 xl:p-16 border border-border angled-border mb-8 sm:mb-10 lg:mb-12 mx-4 sm:mx-0 bg-white shadow-md hover:shadow-xl transition-all duration-300">
                <Mail className="w-8 sm:w-10 lg:w-12 h-8 sm:h-10 lg:h-12 text-foreground mx-auto mb-6 sm:mb-8 lg:mb-10" />
                <a
                  href="mailto:hello@haestus.dev"
                  className="text-mobile-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-heading font-bold text-foreground hover:opacity-70 transition-opacity duration-200 block mb-4 sm:mb-5 lg:mb-6 break-all"
                >
                  hello@haestus.dev
                </a>
                <p className="text-mobile-xs sm:text-sm lg:text-base text-muted-foreground font-medium">We respond within 24 hours.</p>
              </div>
            </ScrollReveal>

            <ScrollReveal delay={400}>
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 sm:gap-5 lg:gap-6 px-4 sm:px-0">
                <a
                  href="#portfolio"
                  className="enhanced-button text-sm lg:text-base xl:text-lg font-semibold px-8 lg:px-12 xl:px-14 py-3 lg:py-4 rounded-full bg-black text-white hover:bg-gray-800 hover:shadow-2xl transition-all duration-300 text-center"
                >
                  View My Work →
                </a>
                <a
                  href="/portal"
                  className="enhanced-button text-sm lg:text-base xl:text-lg font-semibold px-8 lg:px-12 xl:px-14 py-3 lg:py-4 rounded-full border-2 border-[#1ebda5] text-[#1ebda5] hover:bg-[#1ebda5] hover:text-white hover:shadow-2xl transition-all duration-300 text-center"
                >
                  Clients
                </a>
              </div>
